...
Last run: **2026-09-10T07:28:22+00:00** · 95.8s · 0 errors, 11 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=166, parsed=162, last=2026-07, backfill_remaining=0, seconds=5.4 |
| `rbi_wss` | ok | n_weeks=882, last=2026-08-28, backfill_remaining=0, seconds=4.8 |
| `rbihub` | ok | 4 series, seconds=1.9 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=28.3 |
| `india_misc` | ok | seconds=3.4 |
| `market` | ok | 27 series, seconds=45.4 |
| `india_external` | ok | n=3, seconds=1.9 |
| `official_rates` | ok | n=3, seconds=4.7 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (162d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (162d) — mirror lag, patch the tail from another route
...
|---|---|---|---|---|
| `fx_AUD` | AUD per USD | 13955 | 1971-01-04 | 2026-09-04 |
| `fx_BRL` | BRL per USD | 7945 | 1995-01-02 | 2026-09-04 |
| `fx_CAD` | CAD per USD | 13968 | 1971-01-04 | 2026-09-04 |
| `fx_CHF` | CHF per USD | 13962 | 1971-01-04 | 2026-09-04 |
| `fx_CNY` | CNY per USD | 11402 | 1981-01-02 | 2026-09-04 |
| `fx_DKK` | DKK per USD | 13961 | 1971-01-04 | 2026-09-04 |
| `fx_EUR` | EUR per USD | 6941 | 1999-01-04 | 2026-09-04 |
| `fx_GBP` | GBP per USD | 13962 | 1971-01-04 | 2026-09-04 |
| `fx_HKD` | HKD per USD | 11462 | 1981-01-02 | 2026-09-04 |
| `fx_INR` | INR per USD | 13454 | 1973-01-02 | 2026-09-04 |
| `fx_JPY` | JPY per USD | 13956 | 1971-01-04 | 2026-09-04 |
| `fx_KRW` | KRW per USD | 11348 | 1981-04-13 | 2026-09-04 |
| `fx_MXN` | MXN per USD | 8230 | 1993-11-08 | 2026-09-04 |
| `fx_MYR` | MYR per USD | 13940 | 1971-01-04 | 2026-09-04 |
| `fx_NOK` | NOK per USD | 13961 | 1971-01-04 | 2026-09-04 |
| `fx_NZD` | NZD per USD | 13946 | 1971-01-04 | 2026-09-04 |
| `fx_SEK` | SEK per USD | 13961 | 1971-01-04 | 2026-09-04 |
| `fx_SGD` | SGD per USD | 11461 | 1981-01-02 | 2026-09-04 |
| `fx_THB` | THB per USD | 11381 | 1981-01-02 | 2026-09-04 |
| `fx_TWD` | TWD per USD | 10475 | 1983-10-03 | 2026-09-04 |
| `fx_ZAR` | ZAR per USD | 11705 | 1980-01-02 | 2026-09-04 |
| `brent_daily` | Brent crude, daily | 9967 | 1987-05-20 | 2026-09-01 |
| `wti_daily` | WTI crude, daily | 10236 | 1986-01-02 | 2026-09-01 |
| `vix_daily` | VIX close, daily | 9268 | 1990-01-02 | 2026-09-08 |
