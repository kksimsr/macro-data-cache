...
Last run: **2026-08-25T03:28:28+00:00** · 122.1s · 0 errors, 10 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=165, parsed=161, last=2026-06, backfill_remaining=0, seconds=24.7 |
| `rbi_wss` | ok | n_weeks=880, last=2026-08-14, backfill_remaining=0, seconds=5.7 |
| `rbihub` | ok | 4 series, seconds=1.6 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=23.0 |
| `india_misc` | ok | seconds=18.2 |
| `market` | ok | 27 series, seconds=44.0 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (146d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (146d) — mirror lag, patch the tail from another route
