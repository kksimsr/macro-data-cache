...
Last run: **2026-09-15T07:58:45+00:00** · 82.8s · 0 errors, 11 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=166, parsed=162, last=2026-07, backfill_remaining=0, seconds=5.0 |
| `rbi_wss` | ok | n_weeks=883, last=2026-09-04, backfill_remaining=0, seconds=5.0 |
| `rbihub` | ok | 4 series, seconds=1.6 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=17.5 |
| `india_misc` | ok | seconds=4.3 |
| `market` | ok | 27 series, seconds=44.2 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (167d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (167d) — mirror lag, patch the tail from another route
