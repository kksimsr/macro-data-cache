...
Last run: **2026-08-26T03:34:21+00:00** · 89.9s · 0 errors, 10 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=165, parsed=161, last=2026-06, backfill_remaining=0, seconds=4.4 |
| `rbi_wss` | ok | n_weeks=880, last=2026-08-14, backfill_remaining=0, seconds=5.0 |
| `rbihub` | ok | 4 series, seconds=1.6 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=25.7 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (147d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (147d) — mirror lag, patch the tail from another route
...
| `vix_daily` | VIX close, daily | 9257 | 1990-01-02 | 2026-08-24 |
