...
Last run: **2026-09-01T07:57:10+00:00** · 85.7s · 0 errors, 11 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=166, parsed=162, last=2026-07, backfill_remaining=0, seconds=4.5 |
| `rbi_wss` | ok | n_weeks=881, last=2026-08-21, backfill_remaining=0, seconds=6.0 |
| `rbihub` | ok | 4 series, seconds=1.6 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=22.2 |
| `india_misc` | ok | seconds=3.4 |
| `market` | ok | 27 series, seconds=44.1 |
| `india_external` | ok | n=3, seconds=1.4 |
| `official_rates` | ok | n=3, seconds=2.4 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (153d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (153d) — mirror lag, patch the tail from another route
