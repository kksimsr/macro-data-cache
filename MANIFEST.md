...
Last run: **2026-08-29T09:18:33+00:00** · 89.6s · 0 errors, 11 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=165, parsed=161, last=2026-06, backfill_remaining=0, seconds=4.8 |
| `rbi_wss` | ok | n_weeks=881, last=2026-08-21, backfill_remaining=0, seconds=4.6 |
| `rbihub` | ok | 4 series, seconds=1.7 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=23.0 |
| `india_misc` | ok | seconds=4.8 |
| `market` | ok | 27 series, seconds=45.6 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (150d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (150d) — mirror lag, patch the tail from another route
...
| `vix_daily` | VIX close, daily | 9260 | 1990-01-02 | 2026-08-27 |
