...
Last run: **2026-09-08T07:24:22+00:00** · 126.1s · 0 errors, 11 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=166, parsed=162, last=2026-07, backfill_remaining=0, seconds=4.7 |
| `rbi_wss` | ok | n_weeks=882, last=2026-08-28, backfill_remaining=0, seconds=5.7 |
| `rbihub` | ok | 4 series, seconds=1.7 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=28.9 |
| `india_misc` | ok | seconds=3.7 |
| `market` | ok | 27 series, seconds=43.5 |
| `india_external` | ok | n=3, seconds=1.7 |
| `official_rates` | ok | n=3, seconds=36.1 |

## Warnings

- *market* — fx_INR stale: last obs 2026-08-28 is 11d old (limit 10d)
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (160d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (160d) — mirror lag, patch the tail from another route
...
| `vix_daily` | VIX close, daily | 9266 | 1990-01-02 | 2026-09-04 |
