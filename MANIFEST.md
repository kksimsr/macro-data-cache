...
Last run: **2026-08-27T13:00:28+00:00** · 90.8s · 0 errors, 10 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=165, parsed=161, last=2026-06, backfill_remaining=0, seconds=4.3 |
| `rbi_wss` | ok | n_weeks=880, last=2026-08-14, backfill_remaining=0, seconds=4.5 |
| `rbihub` | ok | 4 series, seconds=1.7 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=28.7 |
| `india_misc` | ok | seconds=4.0 |
| `market` | ok | 27 series, seconds=43.0 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (148d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (148d) — mirror lag, patch the tail from another route
...
| `vix_daily` | VIX close, daily | 9258 | 1990-01-02 | 2026-08-25 |
