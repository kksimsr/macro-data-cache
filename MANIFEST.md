...
Last run: **2026-09-11T07:26:33+00:00** · 85.6s · 0 errors, 11 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=166, parsed=162, last=2026-07, backfill_remaining=0, seconds=4.8 |
| `rbi_wss` | ok | n_weeks=882, last=2026-08-28, backfill_remaining=0, seconds=5.1 |
| `rbihub` | ok | 4 series, seconds=1.7 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=21.9 |
| `india_misc` | ok | seconds=2.9 |
| `market` | ok | 27 series, seconds=43.7 |
| `india_external` | ok | n=3, seconds=1.2 |
| `official_rates` | ok | n=3, seconds=4.3 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (163d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (163d) — mirror lag, patch the tail from another route
...
| `vix_daily` | VIX close, daily | 9269 | 1990-01-02 | 2026-09-09 |
