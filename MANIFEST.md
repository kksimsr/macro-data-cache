...
Last run: **2026-09-19T07:31:18+00:00** · 153.9s · 0 errors, 10 warnings

| source | status | detail |
|---|---|---|
| `rbi_forward_book` | ok | n_months=166, parsed=162, last=2026-07, backfill_remaining=0, seconds=12.2 |
| `rbi_wss` | ok | n_weeks=884, last=2026-09-11, backfill_remaining=0, seconds=59.8 |
| `rbihub` | ok | 4 series, seconds=1.6 |
| `nsdl_fpi` | ok | n=8, last=2026-08, backfill_remaining=19, seconds=26.2 |
| `india_misc` | ok | seconds=4.4 |
| `market` | ok | 27 series, seconds=43.3 |
| `india_external` | ok | n=3, seconds=1.3 |
| `official_rates` | ok | n=3, seconds=5.1 |
...
- *rbihub* — sdmx-indices-of-reer-neer-monthly stale: last obs 2026-04-30 (171d) — mirror lag, patch the tail from another route
- *rbihub* — sdmx-forward-premia-inter-bank stale: last obs 2026-04-30 (171d) — mirror lag, patch the tail from another route
...
| `vix_daily` | VIX close, daily | 9275 | 1990-01-02 | 2026-09-17 |
